        ...
        {filteredPosts.length > POSTS_PREVIEW_COUNT && (
          <div className="mt-8 flex justify-center">
            ...
            >
              ...
              <span className={`inline-flex h-5 w-5 items-center justify-center rounded-full border border-zinc-800 transition-transform duration-300 ${showAllPosts ? "rotate-180" : "rotate-0"}`}>
