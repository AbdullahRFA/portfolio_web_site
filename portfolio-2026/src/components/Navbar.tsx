    ...
    <nav className="sticky top-0 z-50 w-full border-b border-zinc-900 bg-zinc-950/80 backdrop-blur-md transition-all duration-300">
          ...
          <a
            ...
            className={`text-xs font-black uppercase tracking-widest px-4 py-2 rounded-full transition-all duration-300 transform hover:-translate-y-0.5 ${
              activeSection === "contact"
                ? "bg-linear-to-r from-fuchsia-500 to-cyan-500 text-white shadow-[0_0_20px_rgba(6,182,212,0.3)]"
                : "bg-zinc-900 border border-zinc-800 text-cyan-400 hover:text-white hover:bg-linear-to-r hover:from-cyan-500 hover:to-blue-600 hover:border-transparent shadow-[0_0_15px_rgba(6,182,212,0.1)] hover:shadow-[0_0_25px_rgba(6,182,212,0.35)]"
            }`}
          >
            Hire Me
          </a>
      ...
      {isOpen && (
        <div className="md:hidden border-b border-zinc-900 bg-zinc-950/95 backdrop-blur-lg px-6 py-5 space-y-3 flex flex-col transition-all shadow-2xl relative">
          <div className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-cyan-500 via-blue-500 to-fuchsia-500" />
          {navLinks.map((link) => {
            const linkId = link.href.replace("#", "");
            const isActive = activeSection === linkId;
          ...
          <a
            href="#contact"
            onClick={(e) => handleScroll(e, "#contact")}
            className="text-xs font-black text-center uppercase tracking-widest py-3 bg-linear-to-r from-cyan-500 via-blue-500 to-fuchsia-500 text-white rounded-xl shadow-[0_0_15px_rgba(6,182,212,0.2)]"
          >
            Hire Me
          </a>
        </div>
